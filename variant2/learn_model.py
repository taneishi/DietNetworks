...
def main():
    ...
    parser.add_argument('--n_hidden_t_dec', default=[100], help='List of theta_prime transformation hidden units')
    ...
    parser.add_argument('--optimizer', type=str, default='rmsprop', help='Optimizer to use for training (rmsprop or adam)')
    parser.add_argument('--patience', type=int, default=100, help='Number of epochs without validation improvement after which to stop training')
    parser.add_argument('--batchnorm', '-bn', type=int, default=0, help='Whether to use BatchNorm in the main network')
    ...
    parser.add_argument('-resume', type=bool, default=False, help='Whether to resume job')
    parser.add_argument('-exp_name', type=str, default='dietnets_final_',
            help='Experiment name that will be concatenated at the beginning of the generated name')
    parser.add_argument('--random_proj', '-rp', type=int, default=0, help='Whether to use random projections as embedding')
